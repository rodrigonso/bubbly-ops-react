    ...
    return (
			<React.Fragment>
				<div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", backgroundColor: "#2c3e50", height: 60}} >
					...
					<div onClick={this.handleDrawer} style={{ marginLeft: 200, marginTop: 15, fontSize: 20, color: "#ecf0f1" }} ><i class="fas fa-bars"></i></div>
				</div>
				<div  >
					<Drawer visible={isOpen} closable={false} onClose={this.handleDrawer} bodyStyle={{ height: "100%", backgroundColor: "#2c3e50" }}  >
						...
						<div style={{ marginTop: 20, width: "100%", marginLeft: -25, width: 260 }} >
							<Menu theme="dark" style={{ backgroundColor: "#2c3e50", fontWeight: 600, fontSize: 20 }}  >
								<Menu.Item><NavLink  to="/" >Home</NavLink></Menu.Item>
								<Menu.Item><NavLink  to="/jobs" >Jobs</NavLink></Menu.Item>
								<Menu.Item><NavLink  to="/earnings" >Earnings</NavLink></Menu.Item>
							</Menu>
						</div>
						<Divider style={{ backgroundColor: "rgba(255, 255, 255, 0.4", marginLeft: -10 }} /> 
						<Button style={{ marginTop: 400, marginLeft: 65 }} onClick={this.handleLogout}>Logout</Button>
					</Drawer>
				</div>
			</React.Fragment>
    )
